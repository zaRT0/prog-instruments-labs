...
class Bank:
    ...
    def credit_Balance(self) -> None:
        """
        this method displays the credit balance screen.
        args: self
        return: None
        """
        ...
        self.up_amnt_lbl1 = Label(
            self.credframe,
            text="Welcome {} to Credit Services".format(self.user),
            bg="#777777",
            font=("Times", "20", "bold"),
            fg="#ffffff",
        )
        ...
        self.up_amnt_lbl2 = Label(
            self.credframe,
            text="Enter amount to credit",
            bg="#777777",
            font=("Times", "26", "bold"),
            fg="#ffffff",
        )
        ...
        self.credframe.grid(padx=self.ws * 0.3, pady=self.hs * 0.2)

    def credit(self) -> None:
        """
        this method performs credit operation and update the user's balance.
        args: self
        return: None
        """
        if self.up_amnt.get():
            try:
                ...
                bal = c.fetchone()[0]
                cmd = "update user SET balance=balance+{} where name='{}'".format(
                    amnt, self.user
                )
                c.execute(cmd)
                db.commit()
            ...
            messagebox.showerror(
                "!!Input Error!!", "Please Enter Some Amount to Credit"
            )
    ...
    def debframe(self) -> None:
        """
        this method displays the debit balance screen.
        args: self
        return: None
        """
        ...
        self.up_amnt_lbl1 = Label(
            self.debit_Balance,
            text="Welcome {} to Debit Services".format(self.user),
            font=("Times", "20", "bold"),
            fg="#ffffff",
            bg="#777777",
        )
        ...
        self.debit_Balance.grid(padx=self.ws * 0.3, pady=self.hs * 0.2)
    ...
    def update_balance(self) -> None:
        """
        this method performs the debit operation and update the users balance
        args: self
        return: None
        """
        if self.up_amnt.get():
            try:
                ...
                if bal:
                    if amnt <= bal:
                        ...
                        s = "\nInsufficient account balance\nyou only have {}rs in your account".format(
                            bal
                        )
                ...
                messagebox.showerror(
                    "!!Value Error!!", "!!ERROR!!Enter Vaid Amount to Debit\n"
                )

            except Exception as error:
                messagebox.showerror(
                    "!!DataBase Connectivity Error!!", "!!ERROR!!{}".format(error)
                )
    ...
    def show_f(self) -> None:
        ...
        self.f.grid(padx=self.ws * 0.3, pady=self.hs * 0.2)
    ...
    def show_profile(self) -> None:
        ...
        try:
            ...
            messagebox.showerror(
                "DataBASE Connectivity", "!!Error!!Database Connection!!{}".format(e)
            )
            exit(0)

        self.p_l1 = Label(
            self.profframe,
            text="Account No:{}".format(self.udacc.get()),
            bg="gray",
            font=("Times", "18", "bold"),
            fg="#ffffff",
        )
        ...
        self.p_l2 = Label(
            self.profframe,
            text="User Name:{}".format(self.udname.get()),
            bg="gray",
            font=("Times", "18", "bold"),
            fg="#ffffff",
        )
        ...
        self.p_l3 = Label(
            self.profframe,
            text="Balance:{}".format(self.udbal.get()),
            bg="gray",
            font=("Times", "18", "bold"),
            fg="#ffffff",
        )
        ...
        if old and new:
            try:
                ...
                if old != data[2]:
                    ...
                    c.execute(
                        "update user set password='{}' where name='{}'".format(
                            new, self.user
                        )
                    )
                    db.commit()
                    ...
                    db.close()
                    messagebox.showinfo(
                        "!!Sucess!!", "Your Password is sucessfully updated"
                    )
                    self.show_m3()
    ...
    def change_password(self) -> None:
        ...
        self.up_opass_lbl1 = Label(
            self.passupdate,
            text="Welcome to Password Update Service",
            bg="gray",
            font=("Times", "20", "bold"),
            fg="#abcdef",
        )
            ...
            if self.up_name.get():
                ...
                if name != self.user:
                    ...
                    if name in users:
                        ...
                        c.execute(
                            "update user set name='{}' where name='{}'".format(
                                name, self.user
                            )
                        )
                        db.commit()
                        ...
                        db.close()
                        messagebox.showinfo(
                            "!!Sucess!!", "Updated User Name Sucessfully"
                        )
                    ...
                    messagebox.showerror(
                        "NameError", "This is your old username choose new one"
                    )
    ...
    def updatename(self) -> None:
        ...
        self.up_name_lbl1 = Label(
            self.nameupdate,
            text="Welcome to Update Name Facility",
            bg="gray",
            font=("Times", "20", "bold"),
            fg="#ffffff",
        )
        ...
        self.up_name_lbl2 = Label(
            self.nameupdate,
            text="Your Current Name is : {}".format(self.user),
            bg="gray",
            font=("Times", "20", "bold"),
            fg="#ffffff",
        )
    ...
    def main_frame(self) -> None:
        ...
        self.l0 = Label(
            self.f,
            text="Welcome To PYTHON Banking Services",
            bg="#777777",
            font=("Times", "20", "bold"),
            fg="#abcdef",
        )
    ...
    def signup(self) -> None:
        ...
        self.sb3 = tk.Button(
            ...
            bg="#777777",
            font=("Times", "18", "bold"),
            command=self.show_sf,
            fg="#000000",
        )
        self.sb3.grid(row=3, column=0, padx=66, pady=17)
        self.sp.grid(padx=self.ws * 0.3, pady=self.hs * 0.2)
        ...
        if uname and password and balance:
            try:
                ...
                if d:
                    ...
                    cmd = "insert into user(name,password,balance) values('{}','{}',{})".format(
                ...
                messagebox.showerror(
                    "ERROR", "Please Enter a Valid Amount to Deposit Initial"
                )
